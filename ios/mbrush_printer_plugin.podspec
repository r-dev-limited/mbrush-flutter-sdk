...
# Run `pod lib lint mbrush_printer_plugin.podspec` to validate before publishing.
#
Pod::Spec.new do |s|
  s.name             = 'mbrush_printer_plugin'
  s.version          = '0.0.1'
...
mbrush printer plugin for text chunking, .mbd conversion, and local HTTP upload.
  ...
  # s.resource_bundles = {'mbrush_printer_plugin_privacy' => ['Resources/PrivacyInfo.xcprivacy']}
end
